...
mixin _$LoginController on LoginControllerBase, Store {
  ...
  late final _$loguinAsyncAction =
      AsyncAction('LoginControllerBase.loguin', context: context);

  @override
  Future<void> loguin(String email, String password) {
    return _$loguinAsyncAction.run(() => super.loguin(email, password));
  }
